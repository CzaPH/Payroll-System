<div class="modal fade" id="modal-studentinfo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
         ...
         ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="txtfname" required placeholder="Enter student complete name"
                            class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Sex</label>
            ...
            ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="year_and_section" required placeholder="Enter year and section"
                            class="form-control">
                    </div>
                    </fieldset>
                    <div class="modal-footer">
                        <button type="submit" id="submit" name="Add" class="btn btn-primary button-loading"
